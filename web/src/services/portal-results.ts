...
export const EVIDENCE_SOURCE_LABEL: Record<PortalEvidenceSourceType, string> = {
  ...
  observation: 'Checks of your website and profiles',
  'score-run': 'Score calculations',
  'aeo-audit': 'AI visibility checks',
  'aeo-surface-run': 'AI answer checks',
  'technical-audit': 'Website check',
  'seo-audit': 'Google search check',
  'presence-discovery': 'Online presence check',
  'authority-scan': 'Mentions and links check',
  'backlinks-summary': 'Backlinks',
  'crawler-hit': 'Search engine visits',
  competitor: 'Competitors',
  'content-brief': 'Content plans',
  report: 'Reports',
