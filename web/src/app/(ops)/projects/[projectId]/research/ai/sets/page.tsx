...
/**
 * QS01 — Question sets (staff advanced panel, merged under AI visibility per P13/§8.2).
 *
...
export default function AiQuestionSetsPage() {
  ...
  const columns: ReadonlyArray<ColumnDef<QuerySet>> = [
    ...
    },
    {
      ...
      render: (row) => (
        <a
          href={`/projects/${projectId}/research/ai/sets/${row.id}`}
    ...
    <div className="space-y-6">
      ...
      <PageHeader
        breadcrumbs={[
          ...
          { label: 'AI visibility', href: `/projects/${projectId}/research/ai` }, { label: 'Question sets' },
        ]}
        title="Question sets"
        context={
          <>
