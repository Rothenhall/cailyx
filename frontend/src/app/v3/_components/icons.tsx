/**
 * icons — /v3. Two sets, each doing the job it is good at.
 *
 ...
 *
 * @module app/v3/_components/icons
 */
...
export function PlugIcon({ className }: IconProps) {
  return (
    <svg {...base} className={className}>
      ...
      <path d="M3.4 5.4h9.2v3.3a4.6 4.6 0 0 1-9.2 0V5.4Z" />
...
export function PlusIcon({ className }: IconProps) {
  return (
    <svg {...base} className={className}>
      <path d="M7 2.9h2v4.1h4.1v3H9v4.1H7V9H2.9V7H7V2.9Z" />
    </svg>
  );
}
...
export function GoogleGlyph({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} aria-hidden>
      <path
        fill="#4285F4"
        d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 0 1-2.2 3.32v3.76h3.57c2.08-1.92 3.28-4.74 3.28-8.09Z"
      />
      <path
        fill="#34A853"
        d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.76c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.15-4.53H2.18v3.84A11 11 0 0 0 12 23Z"
      />
      <path
        fill="#FBBC05"
