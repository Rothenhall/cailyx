 ...
 *
 * @module app/v3/_components/TechnicalAuditReport
 */
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col">
      ...
      {measured === 0 ? (
        ...
        <div className="no-scrollbar v3-stagger flex min-h-0 flex-1 flex-col gap-3 overflow-y-auto px-2 py-3">
...
export function ReportStack({ projectId, domain }: { projectId: string; domain: string | null }) {
  ...
  if (loading) return <div className="v3skel h-28 rounded-r4" />;
