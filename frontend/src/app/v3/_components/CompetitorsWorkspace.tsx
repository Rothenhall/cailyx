...
/**
 * Competitors workspace — /v3. Stage 7 of the delivery flow, full canvas.
 *
 ...
 *
 * @module app/v3/_components/CompetitorsWorkspace
 */
        ...
        {loading ? (
          <div className="space-y-2">
            {Array.from({ length: 6 }, (_, i) => (
              <div key={i} className="v3skel h-10 rounded-r3" />
            ))}
          </div>
        ) : rivals.length === 0 ? (
