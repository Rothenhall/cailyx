...
/**
 * ChatBot — /v3. The Cailyx Assistant: a frosted panel that sits under the
 ...
 * arrive through `seed`.
 *
 * @module app/v3/_components/ChatBot
 */
...
function Bubble({ m }: { m: Msg }) {
  ...
  return (
    <div className={`v3msg-in flex flex-col ${isUser ? 'items-end' : 'items-start'}`}>
      {!isUser && (
      ...
      <div
        className={
          isUser
            ? 'v3bubble-user max-w-[86%] rounded-r4 rounded-br-md px-3 py-2 text-body text-text'
            : 'v3bubble-bot max-w-[94%] rounded-r4 rounded-bl-md px-3 py-2 text-body leading-relaxed text-dim'
        }
      >
        {multiline ? (
    ...
    <div className="flex h-full w-full flex-col overflow-hidden rounded-r4 bg-bg-raised/25 backdrop-blur-[1.5px]">
      ...
      <div className="relative min-h-0 flex-1">
        ...
        <div ref={scroller} className="flex h-full flex-col gap-2.5 overflow-y-auto px-4 py-3">
          ...
          {pending && (
            <div className="v3msg-in flex flex-col items-start">
              <div className="mb-1 flex items-center gap-1.5 pl-0.5">
                <span className="grid h-4 w-4 place-items-center rounded-full bg-accent-dim/[0.4] text-caption font-semibold text-accent">
                  C
                </span>
              ...
              <div className="v3bubble-bot flex items-center gap-1 rounded-r4 rounded-bl-md px-3 py-2.5">
                <span className="v3dot h-1.5 w-1.5 rounded-full bg-accent-dim" />
                <span className="v3dot h-1.5 w-1.5 rounded-full bg-accent-dim" />
                <span className="v3dot h-1.5 w-1.5 rounded-full bg-accent-dim" />
              </div>
            </div>
      ...
      <div className="px-3 pb-3 pt-1">
        ...
        >
          <div className="v3composer flex items-end gap-2 rounded-r4 border border-border bg-bg-raised px-3 py-2.5 transition-colors focus-within:border-border-strong">
            <textarea
              ref={taRef}
              value={input}
