 ...
 *
 * @module app/v3/_components/CommandPalette
 */
  ...
  return (
    <div className="fixed inset-0 z-[75] flex items-start justify-center p-4 pt-[12vh]">
      ...
      <div
        ...
        className="v3-pop relative flex max-h-[62vh] w-full max-w-lg flex-col overflow-hidden rounded-r4 border border-border bg-bg-raised shadow-e3"
      >
