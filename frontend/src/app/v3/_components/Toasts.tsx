...
/**
 * Toasts — /v3. A bottom-left stack of short-lived confirmations for actions
 ...
 *
 * @module app/v3/_components/Toasts
 */
    ...
    <div className="pointer-events-none fixed bottom-4 left-4 z-[70] flex flex-col gap-1.5">
      {toasts.map((t) => (
        <button
          ...
          className={`v3-pop pointer-events-auto flex max-w-[320px] items-center gap-2 rounded-r3 border bg-bg-raised/90 px-3 py-2 text-left text-body shadow-[0_18px_44px_-20px_rgba(26,23,18,0.5)] backdrop-blur ${
