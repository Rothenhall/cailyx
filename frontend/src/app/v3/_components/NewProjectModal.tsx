...
/**
 * NewProjectModal — /v3. Creates a project (`POST /projects`). Shown on demand
 ...
 *
 * @module app/v3/_components/NewProjectModal
 */
  ...
  return (
    <div className="fixed inset-0 z-[65] flex items-start justify-center p-4 pt-[14vh]">
      ...
      <form
        ...
        onSubmit={submit}
        className="v3-pop relative w-full max-w-sm overflow-hidden rounded-r4 border border-border bg-bg-raised shadow-e3"
      >
