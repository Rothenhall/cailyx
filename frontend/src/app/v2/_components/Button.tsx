 ...
 *
 *  - `.v2-nopress` opts every one of these out of the CSS `:active` rule in
 *    v2.css. That rule exists for plain `<button>`s; here motion owns the
 ...
 *
 * @module app/v2/_components/Button
 */
...
const buttonVariants = cva(
  'v2-nopress inline-flex items-center justify-center gap-1.5 whitespace-nowrap rounded-r2 font-medium ' +
