...
/**
 * Digital Presence — /v2. The card above Audits.
 *
 ...
 *
 * @module app/v2/_components/DigitalPresence
 */
...
export function DigitalPresence({
  ...
  return (
    <div className="pointer-events-auto flex w-full max-w-[320px] shrink-0 flex-col overflow-hidden rounded-r4 bg-bg-raised/25 backdrop-blur-[1.5px]">
      {/* header */}
      ...
      <div className="min-h-0 px-3 pb-3">
        {skeleton ? (
          <div className="space-y-1.5">
            <div className="v2skel h-6 rounded-r2" />
            <div className="v2skel h-14 rounded-r3" />
          </div>
        ) : !projectId ? (
