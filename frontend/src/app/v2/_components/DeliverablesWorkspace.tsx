...
/**
 * DeliverablesWorkspace — /v2. What the client actually receives.
 *
 ...
 *    shipped.
 *
 * @module app/v2/_components/DeliverablesWorkspace
 */
...
import { rel } from '@/app/v2/_lib/audit';
        ...
        {!projectId ? (
          ...
          <div className="space-y-2">
            {Array.from({ length: 4 }, (_, i) => (
              <div key={i} className="v2skel h-12 rounded-r3" />
            ))}
          </div>
        ) : tab === 'reports' ? (
