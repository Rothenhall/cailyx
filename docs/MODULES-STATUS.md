...
### Wave 7 — Client Portal & Admin Console revamp (2026-09-20/21, C1 + §11.0 cleanup + C7 done in this worktree; C2–C6 status as last synced here — see their own branches/merges for current state)
